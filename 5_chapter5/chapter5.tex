...
\begin{figure}[t!]
    \centering
    \includegraphics[width=\linewidth]{5_chapter5/figures/standard_deviation/vowel_nasal_Fricative_increase_font.pdf}
    \caption{Cross‑language range of accuracies for MoA classes: vowel, nasal, and fricative. Accuracy is taken from layer 7 across each English–Spanish pretraining mixtures. Solid blue lines and bands show the unweighted mean and range across English, Spanish, French, and Polish, while dashed red lines and bands show the corresponding values when language accuracies are weighted by phoneme token counts in test data.}%\hl{NEEDS EDITING!!!}}
    \label{ed_fig:moa_class_nasal}
\end{figure}
...
\begin{figure}%[h]
    \centering
    \includegraphics[width=\linewidth]{5_chapter5/figures/standard_deviation/vowel_nasal_Fricative_2.pdf}
    \caption{Mean nasal phoneme accuracy at layer~7 for English, Spanish, and Polish across all pretraining mixtures. The figure shows accuracy for nasal phonemes in English and Spanish, French and Polish, for different English and Spanish pretraining mixtures. \hl{NEEDS EDITING!!!}}
    \label{ed_fig:moa_class_nasal}
\end{figure}
...
\begin{figure}%[h]
    \centering
    \includegraphics[width=\linewidth]{5_chapter5/figures/moa_single_plots/test_tap_trill_diphthongs/5_vowel_diphthong_language_colours.pdf}
    \caption{Diphthongs are all included in this graph.}
    \label{ed_fig:moa_class_vowel}
\end{figure}

%\hl{testing tap trill and diphthongs}
\newpage
\clearpage

\begin{figure}%[h]
    \centering
    \includegraphics[width=\linewidth]{5_chapter5/figures/moa_single_plots/test_tap_trill_diphthongs/3_diphthong.pdf}
    \caption{Diphthongs are all included in this graph.}
    \label{ed_fig:moa_class_vowel}
\end{figure}
...
\begin{figure}
    \centering
    \includegraphics[width=\linewidth]{5_chapter5/figures/moa_single_plots/test_tap_trill_diphthongs/3_tap.pdf}
    \caption{Taps are all included in this graph.}
    \label{ed_fig:moa_class_vowel}
\end{figure}
\begin{figure}%[t]
    \centering
    \includegraphics[width=\linewidth]{5_chapter5/figures/moa_single_plots/test_tap_trill_diphthongs/3_trill.pdf}
    \caption{Trills are all included in this graph.}
    \label{ed_fig:moa_class_vowel}
\end{figure}
...
\begin{figure}%[t]
    \centering
    \includegraphics[width=\linewidth]{5_chapter5/figures/moa_single_plots/test_tap_trill_diphthongs/2_tap_trill_language_colours_upper_legend.pdf}
    \caption{Taps and Trills are all included in this graph.}
    \label{ed_fig:moa_class_vowel}
\end{figure}
...
\begin{figure}%[t]
    \centering
    \includegraphics[width=\linewidth, height=0.45\textheight]{5_chapter5/figures/moa_single_plots/test_tap_trill_diphthongs/4_tap_trill_diphthong_language_colours.pdf}
    \caption{Diphthongs, Taps and Trills are all included in this graph.}
    \label{ed_fig:moa_class_vowel}
\end{figure}
