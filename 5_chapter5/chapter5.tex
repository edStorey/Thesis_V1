...
\begin{table}[t]
    ...
    \begin{tabular}{lp{7cm}p{6cm}}
        \hline
        \textbf{Group} & \textbf{Logical definition} & \textbf{Description} \\
        \hline
        Shared-English 
        & English AND Spanish
        & Phonemes that appear in English and Spanish. \\[4pt]
        ...
        English-Unique 
        & NOT English AND Spanish
        & Phonemes that appear only in English. \\[4pt]

        Spanish-Unique 
        & NOT Spanish AND English
        & Phonemes that appear only in Spanish. \\[6pt]

        Overlap with En/Es (Fr) 
        & French AND (English OR Spanish)
        & French phonemes that are also present in English or Spanish. \\[4pt]

        Overlap with En/Es (Pl) 
        & Polish AND (English OR Spanish)
        & Polish phonemes that are also present in English or Spanish. \\[6pt]

        French-Unique 
        & NOT French AND (English OR Spanish)
        & Phonemes that appear only in French. \\[4pt]

        Polish-Unique 
        & NOT Polish AND (English OR Spanish)
        & Phonemes that appear only in Polish. \\
        \hline
    \end{tabular}
    \caption{Logical definitions of phoneme groups used in our analysis across English (En), Spanish (Es), French (Fr) and Polish (Pl).}
    \label{tab:phoneme-groups}
\end{table}
\fi
