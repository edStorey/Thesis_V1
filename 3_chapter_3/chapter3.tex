...
Argue the benefits of parameter efficient training vs high parameter models this would show size of models in parameter counts and the relativity to GPU size. I can make an argument that Quartznet could be trained on a single GPU wherease wav2vec 2.0 required 64 GPUs and fine-tuning on 2 to achieve very similar results ON LIBRISPEECH
