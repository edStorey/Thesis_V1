...
\begin{itemize}
    \item It might also be good to have something that leads on to the the enxt chapter, but we could also include that in the conclusion
    \item 
\end{itemize}
