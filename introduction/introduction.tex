...
\begin{itemize}
    ...
    \begin{itemize}
        \item Structure:
        \item Overview/Introduction: 2.5 pages
        \item Thesis Statement: 1.5 pages
        \item Thesis outline: 2.5 pages
        \item Contributions: 2 pages
        \item Publications: 1 page
        \item 1 blank page
    \end{itemize}
    \item Rishabh: 7 pages
    \begin{itemize}
        \item Overview (Main contributions): 4.5 pages
        \item List of Publications: 1 page
        \item Taxonomy (outline, but for graduation by publication): 0.5 pages
        \item Thesis structure: 1 page
    \end{itemize}
    \item Sam: 11 pages
    \begin{itemize}
        \item Structure:
        \item Overview/Introduction: 4.5 pages
        \item Thesis statement: 2 pages
        \item Thesis Outline: 2.5 pages
        \item contributions: 2 pages
    \end{itemize}
    \item Ayushi: 5 pages
    \begin{itemize}
        ...
        \item Outline: 1.5 pages
        \item Original contributions: 1 page
        \item publications: 1 page
        \item blank: 0.5 pages
    \end{itemize}
    \item George: 8 pages
    \begin{itemize}
        \item Overview/Introduction: 3 pages
        \item Thesis Outline: 1.5 pages
        \item Contributions: 3 pages
    \end{itemize}
\end{itemize}
...
\begin{itemize}
    \item An opening sentence about 
    \item Some reasons as to why ASR is important, 1 paragraph max
    \item A reference to how, in 2014, things changed to DNNs/ AI
    \item How that has ballooned into AI
    \item What AI is used for and why it is important for everyone to have access to ASR
    \begin{itemize}
        \item Subtitles for the deaf
        \item Lectures, zoom calls, something academic
        \item Speech to text for people with mobility issues, or dyslexia
        \item Speech interfaces 
        \item Bank speech interfaces, speech interfaces
    \end{itemize}
    \item ASR technologies are now big buisness? - dunno if we need this one
    \item 
    \item However, it still struggles with certain languages
    \item List some groups that are still problematic, accents dialects languages
    \item I could expand to cross-talk, or speech impediments maybe
    \item Then a short section on the technical details
    \item Very brief ferences to early DNN ASRs
    \item very brief mention of Transformers
    \item Explain that labelling data is expensive and time consuming
    \item SSL models and the removal of labelled data
    \item and then a mention of the imbalance between recognition across languages
    \item How monolingual models do better, but bypass some of the benefits
    \item We want to be able to design ASR models that can reasonably adapt to new languages
    \item With this speech, domains with less data have a better chance of inclusion
    \begin{itemize}
        \item disabled people who speak in accents or small languages will not be excluded
    \end{itemize}
    \item So, how do we go about this? Well, first we need to understand the scale of the problem
    \item Then we move on to a summary of the chapters and thesis structure.
\end{itemize}

\begin{itemize}
    \item \hl{1st paragraph}
    \item The very concept of speech
    \item The concept of signals and complexity
    \item transcription/text and it being a simplification 
    \item all of the information in a speech signal
    \begin{itemize}
        \item We want to show this with a spectrogram on the next page, so all of the things in a spectrogram will be listed here
        \item Word
        \item Letter 
        \item phonemes
        \item Articulations
...
Automatic transcription of the spoken word has long been the aim of researchers around the world. 

Human beings have been communicating through speech for thousands of years, language

Spoken language is arguably the most important form of communication in the human race

Spoken audio signals are complex and contain a lot of information, that we distill it into a text transcript. 

What is speech, why is transcription improtant why is automatic transcription important?

\hl{Somewhere here I will have a spectrogram that shows multiple things, such as formants and a whole word, it is a good eye-catching opener, maybe I have it referred to in the introduction}
\fi
%Speech and language have underpinned human society for hundreds of thousands of years. 


%The ability to confer complex information through speech has been crucial to human development throughout history. Communication through speech and language has allowed humanity to develop into large societies all across the world. The invention of the written language gave humans the ability to communicate over large distances. Writing even allowed us to pass down knowledge to future generations. Technology has forever focused on spreading human communication, making it as efficient and far-reaching as possible. The printing press, the radio, the telephone, the television, and the internet have all furthered humanity's ability to communicate. So it might seem strange then that until recently, we had no reliable way of automatically transcribing speech. 
